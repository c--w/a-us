...
import { FossilDeltaSerializer } from './serializer/FossilDeltaSerializer.mjs';
...
import { ClientState } from './transport/Transport.mjs';
...
class Room {
    constructor(presence) {
        ...
        this._serializer = new NoneSerializer();
